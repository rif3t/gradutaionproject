          ...
          <Col lg={12} md={12} sm={12}>
            <Card className="quickuse">
              <Card.Body>
                ...
                <Button className="quickbtn" variant="outline-info">➕ Create New Course</Button>
                <Button className="quickbtn" variant="outline-info">👥 Bulk Student Enrollment</Button>
                <Button className="quickbtn" variant="outline-info">📈 Generate Department Report</Button>
                <Link to="/Setting">
                  <Button className="quickbtn" variant="outline-info">⚙️ Manage Admin Users</Button>
                </Link>
              </Card.Body>
            </Card>
          </Col>
